...
class TweetCell: DatasourceCell {
  ...
  override var datasourceItem: Any? {
    didSet {
      ...
      profileImageView.loadImageForUrlString(tweet.user.profileImageUrl)
  ...
  let messageTextView: UITextView = {
    let tv = UITextView()
    tv.text = "This is just a sample text TEST"
  ...
  fileprivate func setupBottomButton() {
    ...
    let buttonStackView = UIStackView(arrangedSubviews: [replyButtonContainerView, retweetButtonContainerView,
                                                         likeButtonContainerView, directMessageButtonContainerView])
